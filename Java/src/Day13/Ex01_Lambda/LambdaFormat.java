...
//	@FunctionalInterface 지정 시, 추상메소드가 없거나 2개이상이면 에러 발생
	void method();
...
//(에러)	FuncInterface4 fi5 = (a,b) -> return a + b; // return문만 있을 땐, {} 생략 불가
		// * 반환값만 있는경우, return / {} 동시 생략
